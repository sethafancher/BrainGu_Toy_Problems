...
# and determine what the fewest number of steps is in order to sort the array from least to greatest 
# using the following technique: 
# Each element E in the array can swap places with another element that is arr[E] spaces 
# to the left or right of the chosen element.
...
# Your program should return an integer that specifies the least amount of steps needed in order to sort 
# the array using the following switch sort technique.
